 ...
 * No parameters
 */
public class SumTest extends FirstSuite.BaseTest {
    Calculator calculator = new Calculator();

    @BeforeClass
    public void setUpBeforeSumTestClass(){
        System.out.println("Set up before FirstSuite.SumTest class");
    }
    ...
    public void tearDownAfterSumTestClass(){
        System.out.println("Tear down after FirstSuite.SumTest class");
    }
}
