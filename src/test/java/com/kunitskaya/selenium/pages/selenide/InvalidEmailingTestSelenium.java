...
import static com.kunitskaya.selenium.pages.selenide.ComposeEmailPopup.ALERT_TEXT;
import static com.kunitskaya.selenium.pages.selenide.MailDetailsPage.*;
import static com.kunitskaya.selenium.pages.selenide.MailListingPage.DEFAULT_SUBJECT;
import static com.kunitskaya.selenium.pages.selenide.MailPage.ACCOUNT_ICON;


public class InvalidEmailingTestSelenium extends SeleniumBaseTest {
    @Test
    public void logIn() {
