...
public class AccountConstants {
    ...
    public static final String HOME_PAGE = "https://www.gmail.com";
    public static final String USERNAME = "aktestautomation@gmail.com";
    public static final String PASSWORD = "123456Ak";
    public static final String INBOX = "https://mail.google.com/mail/#inbox";
    public static final String TO = "cfiftest@mail.ru";
